...
class GraficosEngine_API Input {
    ...
    static MikkaiEngine::Camera2* mainCam2;
public:
	Input();
	void Init();
	~Input();
...
/* Function keys */
    ...
    static void SetCam(MikkaiEngine::Camera2* _cam);
	static void key_callback(GLFWwindow* window, int key, int scancode, int action, int mods);
    static void lock_cursor(bool value);
    static void toggle_lock_cursor();
    static void UpdateCameraOrientation(MikkaiEngine::Camera2* mc, glm::vec3 targetPos, float xoffset, float yoffset);
